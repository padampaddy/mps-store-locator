 ...
 */
function call_PincodeClass()
{
    new PincodeClass();
}

if (is_admin()) {
    add_action('load-post.php',     'call_PincodeClass');
    add_action('load-post-new.php', 'call_PincodeClass');
}
...
class PincodeClass
{
    public $name = 'mps_stores_pincode';
