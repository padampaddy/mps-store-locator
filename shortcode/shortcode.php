...
{
    add_action('wp_enqueue_scripts', 'mps_enqueue_scripts_func');
    function mps_enqueue_scripts_func()
    {
...
WHERE city_latitude.meta_key = 'mps_stores_latlong' AND city_longitude.meta_key = 'mps_stores_latlong_long'
